...
9 source(s) used for the theme rewrite (August 25 official launch plus community/independent analysis), plus one user-provided benchmark screenshot.
...
Note: the Qwen 2.5 72B / 23 tok/s figure in the body comes from a user-provided screenshot of a benchmark page ("Run Qwen 2.5 72B on M5 Ultra"); no independent source URL could be located (search on 2026-08-26). The article labels it as a listing, not a lab test.
