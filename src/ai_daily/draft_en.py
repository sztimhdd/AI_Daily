...
def _compile_prompt(topic: dict, chosen: dict, package: dict,
    ...
    return (
        ...
        "Develop the story across 18-24 varied paragraphs and use the "
        "relevant successfully fetched sources; do not pad with repetition. "
        "Rewrite from evidence — never translate "
        "Chinese.\n"
        "Structure: News Peg (first paragraph opens with the decisive "
        "conclusion or clearest image, not a transaction summary) -> Nut Graf -> Smart "
        ...
        "sensory detail. Choose one dominant image or metaphor for the "
        "article and return to it; do not stack unrelated metaphors.\n"
        "3. Rhythm variety: alternate paragraph lengths; use no more than "
        "two standalone punch-line paragraphs in a row; never run the same "
        "bold-claim-then-hedge template for more than half the sections.\n"
        ...
        "can't); sentence fragments sparingly for effect; most sentences "
        "stay under 25 words, with occasional longer sentences for a turn "
        "of thought.\n"
